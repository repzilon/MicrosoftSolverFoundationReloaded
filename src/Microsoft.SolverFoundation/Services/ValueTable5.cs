...
{
	internal sealed class ValueTable5<TValue> : ValueTable<TValue>
	{
		private struct Key : IEquatable<Key>
		{
			...
			{
				return Statics.CombineHash(key0.GetHashCode(), Statics.CombineHash(key1.GetHashCode(), Statics.CombineHash(key2.GetHashCode(), Statics.CombineHash(key3.GetHashCode(), key4.GetHashCode()))));
			}

			public bool Equals(Key other)
			{
				if (key0.Equals(other.key0) && key1.Equals(other.key1) && key2.Equals(other.key2) && key3.Equals(other.key3))
				{
					return key4.Equals(other.key4);
				}
				return false;
			}
		}
		...
		public override IEnumerable<object[]> Keys
		{
			get
			{
				...
				{
					yield return new object[5] { k.key0, k.key1, k.key2, k.key3, k.key4 };
				}
			}
		}
		...
		internal ValueTable5(Domain domain, ValueSet[] indexSets)
