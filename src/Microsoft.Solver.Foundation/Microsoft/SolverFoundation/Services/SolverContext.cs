...
namespace Microsoft.SolverFoundation.Services
{
	...
	public sealed class SolverContext
	{
		...
		{
			object obj = CallContext.GetData("Microsoft.SolverFoundation.Services.__SolverContext");
			if (obj == null)
			{
				obj = new SolverContext();
				CallContext.SetData("Microsoft.SolverFoundation.Services.__SolverContext", obj);
			}
			return obj;
		}
