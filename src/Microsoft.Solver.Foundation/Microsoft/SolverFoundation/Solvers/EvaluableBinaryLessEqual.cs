...
namespace Microsoft.SolverFoundation.Solvers
{
	...
	/// </summary>
	internal sealed class EvaluableBinaryLessEqual : EvaluableBooleanTerm
	{
		...
		internal EvaluableBinaryLessEqual(EvaluableNumericalTerm input1, EvaluableNumericalTerm input2)
		...
		public override EvaluableTerm Substitute(Dictionary<EvaluableTerm, EvaluableTerm> map)
		{
			...
			{
				return new EvaluableBinaryLessEqual(((EvaluableNumericalTerm)value) ?? Input1, ((EvaluableNumericalTerm)value2) ?? Input2);
			}
			return null;
		}
	}
