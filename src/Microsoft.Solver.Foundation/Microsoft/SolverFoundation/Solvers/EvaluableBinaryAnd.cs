...
namespace Microsoft.SolverFoundation.Solvers
{
	...
	/// </summary>
	internal sealed class EvaluableBinaryAnd : EvaluableBinaryBooleanTerm
	{
		internal override TermModelOperation Operation => TermModelOperation.And;

		internal EvaluableBinaryAnd(EvaluableBooleanTerm input1, EvaluableBooleanTerm input2)
			: base(input1, input2)
		{
		}
		...
		{
			return (l > 0.0 && r > 0.0) ? (l + r) : Math.Max(l, r);
		}
		...
		{
			return Substitute(map, (EvaluableBooleanTerm newInput1, EvaluableBooleanTerm newInput2) => new EvaluableBinaryAnd(newInput1, newInput2));
		}
	}
}
